...
namespace GitCommandsTests.Git.Commands
{
    ...
    public class GitCommandsHelperTest
    {
        ...
        [TestCase(CleanMode.OnlyNonIgnored, false, false, "\"path1\"", "-e excludes", "clean -f \"path1\" -e excludes")]
        ...
        [TestCase(CleanMode.OnlyNonIgnored, false, false, "\"path1\" \"path2\"", "-e exclude1 -e exclude2", "clean -f \"path1\" \"path2\" -e exclude1 -e exclude2")]
        [TestCase(CleanMode.OnlyNonIgnored, false, false, null, "-e exclude1 -e exclude2", "clean -f -e exclude1 -e exclude2")]
